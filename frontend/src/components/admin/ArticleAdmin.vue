        ...
        <b-form>
            ...
            <b-form-group label="Categoria:" label-for="article-categoryId">
                <b-form-select id="article-categoryId" v-model="article.categoryId"
                    :options="categories" :disabled="readOnly"/>
            </b-form-group>
            <b-form-group label="Autor:" label-for="article-userId">
                <b-form-select id="article-userId" v-model="article.userId"
                    :options="users" :disabled="readOnly"/>
            </b-form-group>
            <b-form-group label="Conteúdo:" label-for="article-content" v-if="!readOnly">
